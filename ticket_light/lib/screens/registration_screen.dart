...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  String fullName = "", email = "", password = "", confirmPassword = "", phoneNumber = "";
  ...
  void _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        var result = await ApiService.registerUser(fullName, email, password, widget.categoryId, phoneNumber);
        setState(() {
          isLoading = false;
        });
  ...
  Widget _buildInputField(String label, Function(String) onChanged, {String? Function(String?)? validator}) {
    return Padding(
